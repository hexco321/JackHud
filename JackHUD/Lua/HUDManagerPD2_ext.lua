...
HUDListManager.ListOptions = {
	...
	show_ammo_bags = JackHUD:GetOption("show_equipment"),
	show_doc_bags = JackHUD:GetOption("show_equipment"),
	show_body_bags = JackHUD:GetOption("show_equipment"),
	show_grenade_crates = JackHUD:GetOption("show_equipment"),
	...
	--Buff list
	show_buffs = JackHUD:GetOption("show_buffs") 	--Active effects (buffs/debuffs)
...
HUDList.UnitCountItem.MAP = {
	...
	cop =				{ atlas = {0, 5}, color = enemy_color, priority = 5, --[[subtract = { "cop_hostage", "minion" }]] },	--Non-special police
	...
	medic = 			{ atlas = {3, 5}, color = special_color, priority = 6 },
